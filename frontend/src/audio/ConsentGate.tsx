 ...
 *
 * It renders only on the hosted engine. On the on-device path nothing leaves
 * the browser, so there is nothing to agree to, and a tick offered there would
 * be an invitation to the cloud on a screen that currently mentions none. The
 ...
 * tradeoff in the same breath as the choice, never behind a tooltip.
 */
