...
## Corpus Check
- 31 files · ~15,713 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 438 nodes · 441 edges · 31 communities (30 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `98505349`
...
Cohesion: 0.04
Nodes (44): 11. Guideline Corpus, 13. API Contracts, 14. Auth Model, 15. Audit Logging, 16. Security Controls, 18. Traceability, 19. Open Decisions Register, 1. Purpose & Relationship To Other Docs (+36 more)
...
## Knowledge Gaps
- **278 isolated node(s):** `name`, `private`, `license`, `type`, `dev` (+273 more)
...
- **Why does `TRD` connect `Frontend Scripts` to `CI Workflow`, `9. De-Identification Pipeline`, `10. Red-Flag Rules Engine`, `12. LLM Prompt & Response Contracts`, `3. Shared Contracts (`@shared/types`)`?**
