...
## Summary
- 330 nodes · 334 edges · 25 communities (24 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 951 input · 238 output

## Graph Freshness
- Built from commit: `f630fd0f`
...
Cohesion: 0.13
Nodes (15): linter, enabled, rules, level, options, allow, recommended, style (+7 more)
...
## Knowledge Gaps
- **191 isolated node(s):** `name`, `private`, `license`, `type`, `dev` (+186 more)
